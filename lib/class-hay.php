...
HTML;
    ...
    <!-- Piwik, not tracking any privacy-sensitive data -->
    <script>
      var _paq = _paq || [];
      _paq.push(['trackPageView']);
      _paq.push(['enableLinkTracking']);
      (function() {
        var u=(("https:" == document.location.protocol) ? "https" : "http") + "://stats.bykr.org/";
    ...
    <noscript><p><img src="http://stats.bykr.org/piwik.php?idsite=1" style="border:0;" alt="" /></p></noscript>
    <!-- End Piwik Code -->
</body>
</html>
HTML;
