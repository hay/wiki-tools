...
var _typeahead = __webpack_require__(40);
...
var Query = function () {
    ...
    _createClass(Query, [{
        ...
        value: function build(q) {
            var view = {
                where: _underscore2.default.where(q, { 'has': 'where' }),
                minus: _underscore2.default.where(q, { 'has': 'minus' }),
                limit: q.limit
            };

            var hasimage = !!_underscore2.default.findWhere(q, { has: 'image' });
        ...
        value: function (_fetch) {
            ...
            var url = _conf.SPARQL_ENDPOINT.replace('%s', encodeURIComponent(query));
...
exports.default = _vue2.default.component('typeahead', {
    ...
    methods: {
        keydown: function keydown() {
            ...
            (0, _api.search)(this.type, this.input).then(function (data) {
